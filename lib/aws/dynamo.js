...
const queryRecords = async (tableName, projection, condition, filter, values) => {
    const params = {
        TableName: tableName,
...
module.exports = { createRecord, deleteRecord, fetchInverted, fetchRecord, fetchRecords, updateRecord, queryRecords }