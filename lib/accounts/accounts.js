...
const findByEmail = async (email) => {
    ...
    try {
        ...
        return {
            id: account.PK.replace('ACCOUNT_', ''),
...
const createAccount = async (event, context) => {
    ...
    if (!body.password || !body.email || !body.businessName || !body.phone) { throw new Error('Invalid Email or Password') } // TODO add better validation and error logic here
